...
class PurchaseRequestUseCase @Autowired constructor(val purchaseRequestRepository: PurchaseRequestRepository, val purchaseRequestItemRepository: PurchaseRequestItemRepository) {
    ...
    fun get(user: User, purchaseRequestId: Long): PurchaseRequestDetail? {
        return purchaseRequestRepository.findByIdOrNull(purchaseRequestId)?.toDetail()
    }
